...
class User(db.Model, UserMixin):
    ...
    pending_orders = db.relationship('Pending_Order', backref='user', lazy=True)
...
class Product(db.Model):
    ...
    pending_orders = db.relationship('Pending_Order', backref='product', lazy=True)
...
class Club(db.Model):
    ...
    pending_orders = db.relationship('Pending_Order', backref='club', lazy=True)
